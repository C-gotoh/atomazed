...
function Level6:restart()
    self:__init()
    self:load()
end

function Level6:keypressed(key, u)
    if key == "r" then
        self:restart()
...
function Level6:mousepressed(x, y, button)
end
...
function Level6:beginContact(a, b, coll)
