...
function Level7:restart()
    self:__init()
    self:load()
end

function Level7:keypressed(key, u)
    if key == "r" then
        self:restart()
...
function Level7:mousepressed(x, y, button)
end
...
function Level7:beginContact(a, b, coll)
