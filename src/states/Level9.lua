...
function Level9:restart()
    self:__init()
    self:load()
end

function Level9:keypressed(key, u)
    if key == "r" then
        self:restart()
...
function Level9:mousepressed(x, y, button)
end
...
function Level9:beginContact(a, b, coll)
